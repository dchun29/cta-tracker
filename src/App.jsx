...
const CTA_LINES = {
  Red: { color: "#C8102E", textDark: false, directions: ["Howard", "95th/Dan Ryan"], stops: [
    ...
    { name: "Morse", id: "40100" },
    { name: "Loyola", id: "41190" },
    { name: "Granville", id: "40760" },
    { name: "Thorndale", id: "40880" },
    { name: "Bryn Mawr", id: "40340" },
    { name: "Berwyn", id: "40780" },
    { name: "Argyle", id: "40980" },
    { name: "Lawrence", id: "40770" },
    { name: "Wilson", id: "41200" },
    { name: "Sheridan", id: "40540" },
    { name: "Addison", id: "41320" },
    { name: "Belmont", id: "41220" },
    { name: "Fullerton", id: "40530" },
    { name: "North/Clybourn", id: "41090" },
    ...
    { name: "Cermak-Chinatown", id: "41400" },
    { name: "Sox-35th", id: "41000" },
    { name: "47th", id: "40190" },
    { name: "Garfield", id: "40380" },
    { name: "63rd", id: "41170" },
    { name: "69th", id: "40910" },
    { name: "79th", id: "40390" },
    { name: "87th", id: "40980" },
    { name: "95th/Dan Ryan", id: "40100" },
  ]},
  Blue: { color: "#00A1DE", textDark: false, directions: ["O'Hare", "Forest Park"], stops: [
    ...
    { name: "Irving Park", id: "41240" },
    { name: "Addison", id: "40550" },
    { name: "Belmont", id: "41060" },
    { name: "Logan Square", id: "40680" },
    { name: "California", id: "40010" },
    { name: "Western", id: "40180" },
    { name: "Damen", id: "40670" },
    { name: "Division", id: "40590" },
    { name: "Chicago", id: "40320" },
    { name: "Grand", id: "41410" },
    { name: "Clark/Lake", id: "40490" },
    { name: "Washington", id: "40380" },
    { name: "Monroe", id: "40370" },
    { name: "Jackson", id: "40790" },
    { name: "LaSalle", id: "40070" },
    { name: "Clinton", id: "41340" },
    { name: "UIC-Halsted", id: "40810" },
    { name: "Racine", id: "40840" },
    { name: "Illinois Medical District", id: "40420" },
    { name: "Western (Forest Park)", id: "40060" },
    { name: "Kedzie-Homan", id: "40460" },
    { name: "Pulaski", id: "40850" },
    { name: "Cicero", id: "40670" },
    { name: "Austin", id: "40750" },
    { name: "Oak Park", id: "40900" },
  ...
  Brown: { color: "#62361B", textDark: false, directions: ["Kimball", "Loop"], stops: [
    ...
    { name: "Western", id: "41150" },
    { name: "Damen", id: "40090" },
    { name: "Montrose", id: "41420" },
    { name: "Irving Park", id: "40570" },
    { name: "Addison", id: "41500" },
    { name: "Paulina", id: "40660" },
    { name: "Southport", id: "41220" },
    { name: "Belmont", id: "40530" },
    { name: "Fullerton", id: "40800" },
    { name: "Diversey", id: "40460" },
    { name: "Wellington", id: "41210" },
    { name: "Armitage", id: "40660" },
    { name: "Sedgwick", id: "40830" },
  ...
  Green: { color: "#009B3A", textDark: false, directions: ["Harlem/Lake", "Cottage Grove"], stops: [
    ...
    { name: "Laramie", id: "41020" },
    { name: "Cicero", id: "40700" },
    { name: "Pulaski", id: "40480" },
    { name: "Conservatory-Central Park Drive", id: "40030" },
    { name: "Kedzie", id: "41670" },
    { name: "California", id: "41070" },
    { name: "Damen", id: "40170" },
    { name: "Ashland", id: "41360" },
    { name: "Morgan", id: "40130" },
    { name: "Clinton", id: "40490" },
    { name: "Clark/Lake", id: "40260" },
    { name: "State/Lake", id: "41700" },
    { name: "Randolph/Wabash", id: "40680" },
    { name: "Madison/Wabash", id: "40830" },
    { name: "Adams/Wabash", id: "41400" },
    { name: "Roosevelt", id: "41230" },
    { name: "Cermak-McCormick Place", id: "40300" },
    { name: "35th-Bronzeville-IIT", id: "41120" },
    { name: "Indiana", id: "40960" },
    { name: "43rd", id: "41270" },
    { name: "47th", id: "41080" },
    { name: "51st", id: "40990" },
    { name: "Garfield", id: "40180" },
    { name: "King Drive", id: "41140" },
    { name: "Halsted", id: "40130" },
    { name: "Ashland/63rd", id: "40510" },
    { name: "Cottage Grove", id: "40510" },
  ]},
  Orange: { color: "#F9461C", textDark: false, directions: ["Midway", "Loop"], stops: [
    { name: "Midway", id: "40930" },
    { name: "Pulaski", id: "41070" },
    { name: "Kedzie", id: "41130" },
    { name: "Western", id: "41150" },
    { name: "35th/Archer", id: "40310" },
    { name: "Ashland", id: "41060" },
    { name: "Halsted", id: "40120" },
  ...
  Pink: { color: "#E27EA6", textDark: false, directions: ["54th/Cermak", "Loop"], stops: [
    ...
    { name: "Kedzie", id: "40540" },
    { name: "California", id: "40020" },
    { name: "Western", id: "40440" },
    { name: "Damen", id: "40740" },
    { name: "18th", id: "41160" },
    { name: "Polk", id: "40830" },
    { name: "Ashland", id: "41040" },
    { name: "Morgan", id: "40210" },
    { name: "Clinton", id: "40490" },
    { name: "Clark/Lake", id: "40260" },
    { name: "State/Lake", id: "41700" },
    { name: "Washington/Wabash", id: "40680" },
    { name: "Adams/Wabash", id: "40830" },
    { name: "Harold Washington Library", id: "40850" },
    { name: "LaSalle/Van Buren", id: "40160" },
    { name: "Washington/Wells", id: "40730" },
    { name: "Quincy", id: "40040" },
  ...
  Purple: { color: "#522398", textDark: false, directions: ["Linden", "Loop"], stops: [
    ...
    { name: "Central", id: "40040" },
    { name: "Noyes", id: "40140" },
    { name: "Foster", id: "40840" },
    { name: "Davis", id: "40900" },
    { name: "Dempster", id: "40270" },
    { name: "Main", id: "40400" },
    { name: "South Boulevard", id: "40900" },
    { name: "Howard", id: "40900" },
    { name: "Wilson", id: "41200" },
    { name: "Belmont", id: "41220" },
    { name: "Fullerton", id: "40530" },
          ...
          {view==="stops" && ld && (
            <div>
              ...
              <div style={{ background:COLORS.white,borderRadius:16,overflow:"hidden",boxShadow:"0 1px 5px rgba(0,0,0,0.07)",border:`1px solid ${COLORS.gray200}` }}>
                {ld.stops.map((stop,i)=>(
                  <StopRow key={stop.name+i} name={stop.name} lineColor={ld.color} index={i} total={ld.stops.length} onSelect={()=>selectStop(stop)}/>
                ))}
              </div>
            </div>
          )}
