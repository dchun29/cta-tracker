...
const CTA_LINES = {
  ...
  Blue: { color: "#00A1DE", textDark: false, directions: ["O'Hare", "Forest Park"], stops: [
    ...
    { name: "Harlem (O'Hare Branch)", id: "40750" }, { name: "Jefferson Park", id: "41280" }, { name: "Montrose", id: "41330" },
    { name: "Irving Park", id: "40550" }, { name: "Addison", id: "41240" }, { name: "Belmont", id: "40060" },
    { name: "Logan Square", id: "41020" }, { name: "California", id: "40570" }, { name: "Western (O'Hare Branch)", id: "40670" },
    ...
    { name: "Illinois Medical District", id: "40810" }, { name: "Western (Forest Park Branch)", id: "40220" },
    { name: "Kedzie-Homan", id: "40250" }, { name: "Pulaski", id: "40920" }, { name: "Cicero", id: "40970" },
    { name: "Austin", id: "40010" }, { name: "Oak Park", id: "40180" }, { name: "Harlem (Forest Park Branch)", id: "40980" },
  ...
  Brown: { color: "#62361B", textDark: false, directions: ["Kimball", "Loop"], stops: [
    ...
    { name: "Harold Washington Library-State/Van Buren", id: "40850" }, { name: "LaSalle/Van Buren", id: "40160" },
    { name: "Washington/Wells", id: "40730" }, { name: "Quincy", id: "40040" },
  ]},
  Green: { color: "#009B3A", textDark: false, directions: ["Harlem/Lake", "Cottage Grove"], stops: [
    ...
    { name: "Cicero", id: "40480" }, { name: "Pulaski", id: "40030" }, { name: "Conservatory-Central Park Drive", id: "41670" },
  ...
  Pink: { color: "#E27EA6", textDark: false, directions: ["54th/Cermak", "Loop"], stops: [
    ...
    { name: "Adams/Wabash", id: "40680" }, { name: "Harold Washington Library-State/Van Buren", id: "40850" },
...
async function fetchLiveArrivals(stopId, line) {
  try {
    ...
    const arrivals = etas.map(e => {
      const mins = Math.max(0, Math.round((new Date(e.arrT.slice(0,10).replace(/-/g, "/") + " " + e.arrT.slice(11,16) + " GMT-0500") - new Date()) / 60000));
